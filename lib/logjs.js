...
logjs._padNumber	= function(number, length){
	var str = '' + number;
...
{
	// if stacktrace is not defined, use this._topFunctionStack
	...
	var timeStr	= timeNow.getHours() + ':' + logjs._padNumber(timeNow.getSeconds(), 2)
					+ '.' + logjs._padNumber(timeNow.getMilliseconds(), 3);
